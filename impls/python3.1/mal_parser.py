...
def parse_string(s: str, i: int) -> (MalStr, int):
    ...
    return mk_string(python_string), skip_trailing_whitespace(s, i)
...
def parse_number(s: str, i: int) -> (MalInt, int):
    ...
    try:
        return mk_int(int(s[i:j])), skip_leading_whitespace(s, j)
    except ValueError:
